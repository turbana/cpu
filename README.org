...
|   6 |      | Reserved                                    |
|   7 |      | Reserved                                    |
|   8 | SEG0 | Segment (low bit)                           |
|   9 | SEG1 | \vert{}                                     |
|  10 | SEG2 | \vert{}                                     |
|  11 | SEG3 | \vert{}                                     |
|  12 | SEG4 | \vert{}                                     |
|  13 | SEG5 | Segment (high bit)                          |
|  14 |      | Reserved                                    |
|  15 |      | Reserved                                    |

** Memory
Segmentation is used for memory protection. The current segment (found in $flags) is concatenated with the memory type and logical address, forming the physical address that is sent across the bus. Each process is assigned it's own segment. The segment can only be modified from supervisor mode, isolating processes from one another. Segment 0 is considered the supervisor's segment and all devices are memory mapped into data segment 0
