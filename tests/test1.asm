...
start:	ldw	$1, b10110($2)		; 1000 0101 1001 0001 | (7)
	...
	add	$6, $7, 8		; 0000 0011 1111 1110 | (11)
	sub	$3, $0, $1		; 0111 0000 1000 0011 | (12)
	sub	$7, $5, -2		; 0111 0111 0110 1111 | (13)
	and	$2, $4, $0		; 0000 1000 0010 0010 | (14)
	and	$7, $1, -7		; 0000 1100 1100 1111 | (15)
	or	$3, $1, $4		; 0001 0010 0000 1011 | (16)
	or	$4, $1, 1		; 0001 0000 0100 1100 | (17)
	shl	$7, $4, $1		; 0011 0000 1010 0111 | (18)
	shl	$3, $1, 6		; 0011 0010 1100 1011 | (19)
	shr	$1, $6, $7		; 0010 0011 1011 0001 | (20)
	shr	$7, $2, 1		; 0010 0000 0101 0111 | (21)
	sar	$1, $6, 3		; 0010 1001 0111 0001 | (22)
	xor	$3, $5, (010/4)		; 0001 1000 1110 1011 | (23) 2
	s.eq	$1, $4			; 0100 0010 0000 1000 | (24)
	s.ne	$4, 5			; 0100 0010 0110 0001 | (25)
	...
	ldw	$5, 1($3)		; 0110 0000 0101 1101 | (38)
	ldiw	$1, $2($4)		; 0110 1001 0010 0001 | (39)
	sex	$3, $4			; 0011 1000 0010 0011 | (40)
	stiw	3($3), $7		; 0111 1001 0001 1111 | (41)
	ldw	$1, 63($4)		; 1000 1111 1110 0001 | (42)
	stw	-1($1), $5		; 1011 1111 1100 1101 | (43)
