...
start:	ldw	$1, b10110($2)		; 1000 0101 1001 0001 | (7)
	...
	or	$4, $1, 1		; 0001 1000 0100 1100 | (17)
	shl	$7, $4, $1		; 0010 0000 1010 0111 | (18)
	shl	$3, $1, 6		; 0010 0010 1100 1011 | (19)
	shr	$1, $6, $7		; 0010 1011 1011 0001 | (20)
	shr	$7, $2, 1		; 0010 1000 0101 0111 | (21)
	sar	$1, $6, 3		; 0011 0001 0111 0001 | (22)
	xor	$3, $5, (010/4)		; 0011 1000 1110 1011 | (23) 2
	...
	ldw	$5, 1($3)		; 0110 0000 0101 1101 | (41)
	ldiw	$1, $2($4)		; 0110 1001 0010 0001 | (38)
	sex	$3, $4			; 0111 0000 0010 0011 | (39)
	stiw	3($3), $7		; 0111 1001 0001 1111 | (40)
